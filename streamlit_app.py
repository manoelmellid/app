...
st.write("Este proyecto se encuadra dentro de la asignatura Proyecto Integrador I, del Grado de Inteligencia Artificial de la Universidade de Santiago de Compostela.")
